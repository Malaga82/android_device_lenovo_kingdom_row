...
static char *camera_get_parameters(struct camera_device *device)
{
    ...
    if (CAMERA_ID(device) == BACK_CAMERA_ID) {
        ...
        /* Add 5328x2997 to get 16mpix without HDR */
        params.set(CameraParameters::KEY_SUPPORTED_PICTURE_SIZES,
            "4864x2736,4208x3000,4000x3000,4096x2160,3840x2160,3664x2748,4224x2376,3840x2160,3280x2460,3200x2400,2832x2124,3264x1836,3200x1800,2592x1944,2560x1440,2048x1536,1920x1440,1920x1080,1600x1200,1440x1080,1280x768,1280x720,1024x768,800x600,800x480,720x480,640x480,320x240,176x144");
